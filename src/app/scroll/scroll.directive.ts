...
import {CustomScrollService} from "./scroll.service";
...
export class CustomScroll implements AfterViewChecked {
  ...
  constructor(private router: Router, private simplePageScrollService: CustomScrollService) {
  }
